  ...
  const t =
    locale === "fr"
      ? {
          ...
          stap2Tekst: "Notre équipe élabore un plan de transformation détaillé, avec un devis transparent.",
      ...
      ? {
          ...
          stap2Tekst: "Our team draws up a detailed conversion plan, with a transparent quote.",
      ...
      : {
          ...
          stap2Tekst: "Ons team werkt een gedetailleerd verbouwingsplan uit, met transparante offerte.",
