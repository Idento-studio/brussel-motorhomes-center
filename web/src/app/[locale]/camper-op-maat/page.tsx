  ...
  const t =
    locale === "fr"
      ? {
          ...
          stap2Tekst: "Notre équipe élabore en détail l'agencement, les matériaux et les systèmes.",
      ...
      ? {
          ...
          stap2Tekst: "Our team works out the layout, materials and systems in detail.",
      ...
      : {
          ...
          stap2Tekst: "Ons team werkt indeling, materialen en systemen in detail uit.",
